...
exports.DefaultSignatureValidator = void 0;
var crypto_1 = require("crypto");
var DefaultSignatureValidator = (function () {
    function DefaultSignatureValidator() {
    }
    DefaultSignatureValidator.isValid = function (signature, secretKey, responseData) {
        if (!signature) {
            throw new Error("The webhook Signature secret is not set. Make sure that the `CHARGILY_APP_SECRET` config key is set to the correct value.");
        }
        ...
        var computedSignature = (0, crypto_1.createHmac)("sha256", secretKey)
            .update(responseData)
            .digest("hex");
