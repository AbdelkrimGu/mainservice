...
app.post("/webhook-response", function (req, res) {
    ...
    var ress = Webhook_1.DefaultSignatureValidator.isValid(signature, process.env.CHARGILY_APP_SECRET, req.body);
    res.send(ress);
});
var createPayment = function (invoice) { return __awaiter(void 0, void 0, void 0, function () {
    var inv, res_1, data, error_1;
        ...
        switch (_a.label) {
            ...
            case 3:
                ...
                if (axios_1.default.isAxiosError(error_1)) {
                    ...
                    throw new Error("unexpected error: ".concat(error_1));
                }
                return [3, 4];
            case 4: return [2];
        }
